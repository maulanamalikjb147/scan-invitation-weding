...
export function FloatingControls({ playing, onMusic }: { playing: boolean; onMusic: () => void }) {
  return (
    <>
      <nav aria-label="Navigasi undangan" className="font-label fixed bottom-3 left-1/2 z-40 flex max-w-[calc(100vw-20px)] -translate-x-1/2 overflow-hidden rounded-[6px] border border-white/10 bg-[#161712]/90 p-1 shadow-2xl backdrop-blur-xl md:bottom-7 md:p-1.5">
