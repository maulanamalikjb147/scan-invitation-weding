...
export function Hero() {
  return (
    <section id="home" className="noise relative min-h-[100svh] overflow-hidden">
      <Image src="/images/gambar1.jpg" alt="Potret Maulana dan Anisa" fill priority sizes="100vw" className="object-cover object-[50%_52%] md:object-[50%_47%]" />
      ...
      <div className="page-shell relative z-10 flex min-h-[100svh] flex-col justify-end pb-20 pt-28 md:justify-center md:pb-0">
        ...
        <h1 className="font-display max-w-3xl text-[clamp(4rem,11vw,9.25rem)] leading-[.78] tracking-[-.06em]">Maulana <span className="italic text-[#c5a059]">&</span><br />Anisa</h1>
