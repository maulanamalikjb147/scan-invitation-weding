...
export function Footer() {
  return (
    <footer className="relative min-h-[78svh] overflow-hidden">
      <Image src="/images/gambar11.jpg" alt="Maulana dan Anisa" fill sizes="100vw" className="object-cover object-center" />
      ...
      <div className="page-shell relative z-10 flex min-h-[78svh] flex-col items-center justify-end pb-28 text-center">
        ...
        <h2 className="font-display mt-5 text-6xl leading-[.9] md:text-8xl">Maulana <span className="italic text-[#c5a059]">&</span> Anisa</h2>
